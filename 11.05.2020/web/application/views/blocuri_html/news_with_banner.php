...
<section class="info-boxes-section padding-tb-50px">
	<div class="container">
		<div class="row">
			...
			<div class="col-6 col-lg ">
				<div class="info-box p-2 shortcut col-section">
					<h3 class="js-equal-5">Intelegem nevoile tale</h3>
					<p>
						<a href="<?=base_url()?>servicii"><img src="<?=base_url()?>web/public/upload/img/contact.jpg" alt=""></a>
					</p>
					<p>
						<a href="<?=base_url()?>servicii" class="btn btn-md border-2 border-radius-0  text-dark width-120px opacity-9" class="btn btn-md border-2 border-radius-0  text-dark width-120px opacity-9" class="btn btn-md border-2 border-radius-0  text-dark width-120px opacity-9">Apa / Canal</a>
					</p>
				</div>
