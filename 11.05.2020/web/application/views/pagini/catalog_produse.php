...
<div class="col-md-9 right-side-p">
    ...
    <div class="row">
		...
		<?php foreach($categories_cp as $ctg): ?>
		<?php
			...
			<div class="single-product-items">
				<div class="single-items">
					<a href="<?=base_url()?>catalog_produse/categorie/<?=$ctg["slug"]?>">
						...
						<img class="primary-img" src="<?=base_url()?>public/upload/img/nodes/m/<?=$ctgimages[0]?>" alt="uniforme medicale">
						...
						<?php else: ?>
						<img class="primary-img" src="<?=base_url()?>public/assets/img/product/blank_product.jpg" alt="uniforme medicale">
						<?php endif; ?>
					</a>
			...
			<div class="row">
				<div class="shop-item-filter">
					<div class="filter-text">
						<p style="color:#597999;"><?=($site_lang == "en" ? 'Category products:' : 'Produse din categoria:')?> <?=$node->denumire_ro?></p>
					</div>
					<div class="filter-by">
			...
			<div class="single-product-items">
				<div class="single-items">
					<a href="<?=base_url()?>catalog_produse/produs/<?=$product->slug?>">
						...
						<img class="primary-img" src="<?=base_url()?>public/upload/img/catalog_produse/m/<?=$pimages[0]?>" alt="uniforme medicale">
