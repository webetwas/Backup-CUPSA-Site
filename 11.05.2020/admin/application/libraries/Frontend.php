...
class Frontend {
	...
	public $listsucursale = null;
	public $listservicii = null;
	public $listproiecte = null;
	public $allpages = null;
	...
	public function __construct()
	{
		...
		$this->listsucursale = $this->CI->_Application->listsucursale(1);//@is_active true
		$this->listservicii = $this->CI->_Application->listservicii(1);//@is_active true
		$this->listproiecte = $this->CI->_Application->listproiecte(1);//@is_active true
	...
	public function render($data) {
		...
		$fdata = array("application" => (object) [
			...
			"listsucursale"=> $this->listsucursale,
			"listservicii"=> $this->listservicii,
			"listproiecte"=> $this->listproiecte
		);
