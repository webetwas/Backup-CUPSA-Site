...
class Nodes_model extends CI_Model
{
	...
	public function airdrop_check_if_user_has_access($atom_id, $user_id)
	{
		$sql =
		'
			SELECT
				ad.*
			FROM
				airs_airdrop AS ad INNER JOIN
				airs_airdrop_permissions AS adp ON ad.airdrop_id = adp.airdrop_id AND adp.id_user = ' .$user_id. '
			WHERE
				ad.atom_id = ' .$atom_id. '
		';
	...
	public function getFatherNode($node_id)
	{
		$sql =
		'
			SELECT 
