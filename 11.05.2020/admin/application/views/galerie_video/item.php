				...
				<div class="tabs-container">
					...
					<ul role="tablist" class="nav nav-tabs">
						...
						<li role="presentation" class="active">
							<a href="#tab1" data-toggle="tab"><?=(!is_null($item) && !is_null($item->item_name) ? $item->item_name : "Adauga video in galerie");?></a>
						</li>
					</ul>
						...
						<div class="tab-content">
							...
							<div id="tab1" class="tab-pane active">
                                ...
                                <div class="col-sm-9">
																	<?php if(is_null($links)): echo '<h4 style="margin-top:10px;">Nu exista Sectiuni create in Galeria video</h4>'; ?>
                            ...
                            <?php endif; ?>
														...
														<div class="row">
															<div class="form-group">
																<label class="col-sm-2 control-label">Text reprezentativ video-ului</label>
																<div class="col-sm-10">
																	<input type="text" placeholder="Descriere scurta a video-ului" class="form-control" name="<?=$form->item->prefix;?>text_reprezentativ" value="<?=(!is_null($item) && !is_null($item->text_reprezentativ) ? $item->text_reprezentativ : "");?>">
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="form-group">
																<label class="col-sm-2 control-label">Adresa URL pentru Video</label>
																<div class="col-sm-10">
																	<input type="text" placeholder="Adresa url al video-ului" class="form-control" name="<?=$form->item->prefix;?>embed_url" value="<?=(!is_null($item) && !is_null($item->embed_url) ? $item->embed_url : "");?>">
                                  <span class="help-block m-b-none"><i>EX: https://www.youtube.com/watch?v=65_PmYipnpk</i></span>
                                </div>
															</div>
														</div>	                            
																	...
																	<div class="col-lg-2 col-md-4 col-xs-6 col-xs-12 thumb-nomg">
																		<div class="img-thumbnail-btn">
																			<button type="button" id="btnupimg" style="<?=$item->i ? 'visibility:hidden;' : ''?>" class="btn btn-primary btn-fill btn-upfile" data-toggle="modal" data-target="#inpfileModal" onClick="filesetvars('poza', 'poza')">
																				Incarca o imagine <br /> reprezentativa Video-ului<br/><br/><i class="fa fa-picture-o fa-2x" aria-hidden="true"></i>
																			</button>
																		</div>
																	</div>
																</div>
