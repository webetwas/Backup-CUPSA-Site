													...
													<div class="panel-group">
														...
														<div class="row">
															<div class="form-group">
																...
																<div class="col-sm-10">
																	<input type="text" placeholder="Numele Text divers" class="form-control" name="<?=$form->item->prefix;?>atom_name_ro" value="<?=(!is_null($item) && !is_null($item->atom_name_ro) ? $item->atom_name_ro : "");?>" required>
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="form-group">
																...
																<div class="col-sm-10">
																	<input type="text" placeholder="Link-ul Textului accesat din browser" class="form-control" name="<?=$form->item->prefix;?>i_linkhref" value="<?=(!is_null($item) && !is_null($item->i_linkhref) ? $item->i_linkhref : "");?>">
																</div>
															</div>
														</div>
														-->
														...
														<div class="row">
															<div class="form-group">
																...
																<div class="col-sm-10">
																	<input type="text" placeholder="Titlu" class="form-control" name="<?=$form->item->prefix;?>i_titlu" value="<?=(!is_null($item) && !is_null($item->i_titlu) ? $item->i_titlu : "");?>">
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="form-group">
																...
																<div class="col-sm-10">
																	<input type="text" placeholder="Subtitlu" class="form-control" name="<?=$form->item->prefix;?>i_subtitlu" value="<?=(!is_null($item) && !is_null($item->i_subtitlu) ? $item->i_subtitlu : "");?>">
																</div>
															</div>
														</div>
														-->
														...
														<div class="row">
															<div class="form-group">
																...
																<div class="col-sm-10">
																	<input type="text" placeholder="Numele Text divers" class="form-control" name="<?=$form->item->prefix;?>atom_name_en" value="<?=(!is_null($item) && !is_null($item->atom_name_en) ? $item->atom_name_en : "");?>">
																</div>
															</div>
														</div>
														...
														<fieldset>
																<div class="form-group">
																	<div class="col-sm-12">
																		...
																		<button class="btn btn-primary" type="submit" name="<?=$form->item->prefix;?>submit"><?=(isset($uri->item) && $uri->item == "i" ? "Creeaza text divers" : "Salveaza modificarile")?></button>
																	</div>
																</div>
														</fieldset>
													</div>
