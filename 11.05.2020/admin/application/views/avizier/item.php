													...
													<div class="panel-group">
														...
														<div class="row">
															<div class="form-group">
																<label class="col-sm-2 control-label">Titlu <?=$air->air_identnewitem?></label>
																<div class="col-sm-10">
														...
														<div class="row">
															<div class="form-group">
																<label class="col-sm-2 control-label">Titlu <?=$air->air_identnewitem?> <span style="color:red;"> ENG</span></label>
																<div class="col-sm-10">
																	<input type="text" placeholder="" class="form-control" name="<?=$form->item->prefix;?>atom_name_en" value="<?=(!is_null($item) && !is_null($item->atom_name_en) ? $item->atom_name_en : "");?>">
																</div>
															</div>
														</div>														
														<?php endif; ?>
														<div class="row">
															<div class="form-group">
																...
																<div class="col-sm-10">
																	<textarea class="form-control" name="<?=$form->item->prefix;?>i_content_ro"><?=(!is_null($item) && !is_null($item->i_content_ro) ? $item->i_content_ro : "");?></textarea>
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="form-group">
																...
																<div class="col-sm-10">
																	<textarea class="form-control" name="<?=$form->item->prefix;?>i_content_en"><?=(!is_null($item) && !is_null($item->i_content_en) ? $item->i_content_en : "");?></textarea>
																</div>
															</div>
														</div>													
