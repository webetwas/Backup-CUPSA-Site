													...
													<div class="panel-group">
														...
														<div class="row">
															<div class="form-group">
																...
																<div class="col-sm-10">
																	<input type="text" placeholder="Numele complet al membrului" class="form-control" name="<?=$form->item->prefix;?>atom_name_ro" value="<?=(!is_null($item) && !is_null($item->atom_name_ro) ? $item->atom_name_ro : "");?>" required>
																</div>
															</div>
														</div>
