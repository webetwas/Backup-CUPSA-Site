		...
		foreach($airdrops as $airdrop)
		{
			...
			$t .= '<div class="dd3-content" ' .(!(bool)$airdrop["atom_isactive"] ? 'style="border-right:3px solid red;border-radius:0;background:#f2fbff;;"' : 'style="background:#f2fbff;"'). '>';
				$t .= '<span class="lispmn">';
					...
					$t .= '<a href="javascript:void(0);" class="airdrop-items" id="' .$airdrop["airdrop_id"]. '"><i class="fa fa-group"></i> Editeaza accesul utilizatorilor</a>';
...
<div id="dialog-users" title="Cine poate accesa acest item" style="display:none;">
		<div class="form-group">
			<label class="col-sm-2 control-label">Utilizatori: </label>
			<div class="col-sm-10">
				<select multiple data-placeholder="Utilizatori care pot accesa acest item." id="chosen-sl-users" tabindex="4">
				</select>
			</div>
		</div>
</div>