...
class Media extends CI_Controller {
	...
	public function index()
	{
		...
		//$pagini_site = $this->_Pagini->get_pagini_site_assoc_three($page->p->atom_id)
		//media controller este corespondent cu page id 127 /p/comunicate-de-presa
		if($pagini_site = $this->_Pagini->get_pagini_site_assoc_three(127))
		{
		...
		if($media)
		{
			...
			{
				$media[$key_media]->iteme = $this->_Airdrop->get_airdrops_and_images_by_air_controller_and_node_slug('media', $medi->slug, false, true);
			}
