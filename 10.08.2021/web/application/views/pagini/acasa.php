...
<section class="operator-regio padding-tb-30px">
	<div class="container">
		<div class="row">
			...
			if( ($p_acasa->p->yt_link)){
				$youtube_id = explode("watch?v=",$p_acasa->p->yt_link);
				$youtube_id = $youtube_id[1];
			}
			if ($p_acasa->i) { }
			?>
			<div class="col-lg-<?= $p_acasa->p->yt_link ? '6' : '12' ?> hidden text-center text-white" >

				<div class="padding-tb-100px z-index-2 position-relative js-equal-3 border-radius-10 background-overlay" <?= ($p_acasa->p->yt_link ? 'style=" background-image: url(\'https://img.youtube.com/vi/'.$youtube_id.'/hqdefault.jpg\');' : '') ?>">
					<?php if (!empty($p_acasa->p->yt_link)) : ?>
						<a href="<?= $p_acasa->p->yt_link ?>" id="yt-preview" class="z-index-2 position-relative">
							<img src="<?= base_url() ?>/public/assets/img/play-button-light.png" alt="">
						</a>
					<?php endif; ?>
			...
			<div class="col-lg-<?= $p_acasa->p->yt_link ? '6' : '12' ?>">
...
<section class="shortcut-section padding-top-20px">
	<div class="container">
		<div class="row">
			<div class="col-12 col-lg-12 no-gutters">
				<div class="shortcut2 p-3 col-blue row">
					<div class="col-lg-3 text-center center">
						<a href="<?= base_url() ?>public/upload/CE_072021.pdf" target="_blank"><img src="<?= base_url() ?>web/public/upload/img/contor-electromagnetic.jpg" width="80" alt=""></a>
					</div>

					<div class="col-lg-6 text-center center">
						<a href="<?= base_url() ?>public/upload/CE_072021.pdf" target="_blank">
							<h3>Contori Electromagnetici - Raport Citiri</h3>
						</a>
						<!-- 
					...
					<div class="col-lg-3 text-center center"><a href="<?= base_url() ?>p/contori-electromagnetici" class="btn btn-md border-2 border-radius-0 text-dark opacity-9">Detalii</a></div>
				</div>
			</div>
		</div>
	</div>
		    ...
		    <div class="col-lg-6 mb-3">
				<div class="alert-container intelegem p-3 b-radius-10 row">
					...
					<div class="collapse" id="collapseExample2">
						...
						<br />
						<p class="pull-right"><a href="<?=base_url()?>servicii" class="btn btn-md  border-2 border-radius-0  text-dark width-120px opacity-9">Detalii</a>.</p>
					</div>
				</div>
		    </div>
...
<section class="shortcut-section padding-top-20px">
	<div class="container">
		<div class="row">
			<div class="col-12 col-lg-12 no-gutters">
				<div class="shortcut2 p-3 col-blue row">
					<div class="col-lg-3 text-center center"><a href="<?= base_url() ?>p/transmitere-index-autocitit"><img src="<?= base_url() ?>web/public/upload/img/contor.png" width="80" alt=""></a></div>
					<div class="col-lg-6 text-center center"><a href="<?= base_url() ?>p/transmitere-index-autocitit"><h3>Cum să ne transmiteți indexul autocitit?</h3></a></div>
					<div class="col-lg-3 text-center center"><a href="<?= base_url() ?>p/transmitere-index-autocitit" class="btn btn-md border-2 border-radius-0 text-dark opacity-9">Detalii</a></div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-6 col-lg-3">
				<div class="shortcut p-3 col-green">
					...
					<p>
						<a href="<?= base_url() ?>mobilpay/index.php" class="btn btn-md border-2 border-radius-0 text-dark opacity-9">Plateste</a>
					</p>
				</div>
