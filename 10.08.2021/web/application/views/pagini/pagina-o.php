...
<!-- page output -->
	...
	?>
		...
		<div class="col-lg-12 col-md-12">
			<form id="frmFe" method="post" action="<?php echo base_url();?>factura/submit.php">
				<h4 class="text-center">
					SOLICITARE EMITERE FACTURĂ ELECTRONICĂ
				</h4>
				...
				<p class="opacity-7">
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="nume"><span class="fa fa-star fa-xs" style="color:red;"></span> <b>Nume, Prenume / Denumire</b></label>
							<input type="text" class="form-control" id="nume" placeholder="Nume, Prenume / Denumire" name="nume" required>
						</div>
					</div>
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="cnp_cif"><span class="fa fa-star fa-xs" style="color:red;"></span> <b>CNP / CIF</b> (vă solicităm CNP-ul / CIF pentru a fi siguri că solicitantul este și utilizatorul serviciilor asigurate de operator)</label>
							<input type="text" class="form-control" id="cnp_cif" name="cnp_cif" placeholder="CNP / CIF" required>
						</div>
					</div>
					<p>
					...
					<p style="text-align: justify">
						...
						<div class="ml-30">
							...
							<!-- <input type="text" id="trans_factura" name="trans_factura" placeholder="DA" disabled> -->
							...
							<!-- <input type="text" id="trans_sms" name="trans_sms" placeholder="da / nu"> -->
		...
		<script>
			jQuery('#frmFe').on('submit',function(e){
				jQuery('#msg').html('');
				jQuery('#submit').html('Asteapta');
				jQuery('#submit').attr('disabled',true);
				jQuery.ajax({
					url:"<?php echo base_url();?>factura/submit.php",
					type:'post',
					data:jQuery('#frmFe').serialize(),
					success:function(result){
						jQuery('#msg').html(result);
						jQuery('#submit').html('Cererea a fost trimisa cu succes');
						jQuery('#submit').attr('disabled',false);
						jQuery('#frmFe')[0].reset();
					}
				});
				e.preventDefault();
			});
