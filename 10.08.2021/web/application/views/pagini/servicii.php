...
<section class="padding-tb-10px">
	<div class="container">	
		<div class="row  text-center padding-tb-20px d-block  text-capitalize text-large text-dark font-weight-400 margin-bottom-10px back-subtitle" style="padding-top: 10px">
			<div class="col-lg-12">
				<h5><a href="<?=base_url()?>web/public/upload/Declaratie_de_neinterconectare_surse_apa.pdf" target="_blank"><i class="fa fa-file-pdf-o" style="margin: 0 10px 0 10px"></i>Declaratie de neinterconectare surse apa</a></h5>
			</div>
		</div>
	</div>
</section>
