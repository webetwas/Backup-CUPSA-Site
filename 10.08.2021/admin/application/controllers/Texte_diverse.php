...
class Texte_diverse extends CI_Controller {
  ...
  public function index()
  {
		...
		$viewdata["imgpathitem"] = SITE_URL.PATH_IMG_TEXTE_DIVERSE."m/";
		...
		//breacrumb
		$breadcrumb = array("bb_titlu" => "Texte diverse", "bb_button" => null, "breadcrumb" => array());
		$breadcrumb["bb_button"] = array("text" => '<i class="fa fa-plus-square"></i> Adauga text divers', "linkhref" => $this->controller_fake ."/item/i");
		
		$breadcrumb["breadcrumb"][0] = array("text" => "Administrare", "url" => '/');
		$breadcrumb["breadcrumb"][1] = array("text" => "Texte diverse", "url" => null);
    $view = (object) [ 'html' => array(
			0 => (object) ["viewhtml" => "layout/breadcrumb", "viewdata" => $breadcrumb],
      1 => (object) ["viewhtml" => "texte_diverse/index", "viewdata" => $viewdata]
      ), 'javascript' => array(
      1 => (object) ["viewhtml" => "texte_diverse/js_index", "viewdata" => null],
      )
    ];
		...
		switch($this->uriseg->item)
    {
      ...
      break;
		...
		//breacrumb
		$breadcrumb = array("bb_titlu" => "Texte_diverse", "bb_button" => null, "breadcrumb" => array());
		
		$breadcrumb["breadcrumb"][0] = array("text" => "Texte_diverse", "url" => $this->controller_fake);
		$breadcrumb["breadcrumb"][1] = array("text" => "Texte_diverse dd", "url" => null);
    $view = (object) [ 'html' => array(
			0 => (object) ["viewhtml" => "layout/breadcrumb", "viewdata" => $breadcrumb],
      1 => (object) ["viewhtml" => "texte_diverse/item", "viewdata" => $viewdata]
      ), 'javascript' => array(
      1 => (object) ["viewhtml" => "texte_diverse/js_item", "viewdata" => null],
      )
    ];
    $this->frontend->render($view);	
	}
				...
				case UPLOADIMG:
					...
					switch($this->input->post("filetarget"))
					{
						case UPIMGPOZA:
							...
							$locations->path = '../web/' .PATH_IMG_TEXTE_DIVERSE;
