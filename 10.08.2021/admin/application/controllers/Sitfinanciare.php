...
class Sitfinanciare extends CI_Controller {
  ...
  /**
    ...
    public function index()
    {
        ...
        //breacrumb
        $breadcrumb = array("bb_titlu" => "Situatii financiare", "bb_button" => null, "breadcrumb" => array());
        ...
        $breadcrumb["breadcrumb"][1] = array("text" => "Situatii financiare", "url" => null);
        
        $view = (object) [ 'html' => array(
                0 => (object) ["viewhtml" => "layout/breadcrumb", "viewdata" => $breadcrumb],
                1 => (object) ["viewhtml" => "sitfinanciare/index", "viewdata" => $viewdata]
            ), 'javascript' => array(
                1 => (object) ["viewhtml" => "sitfinanciare/js_index", "viewdata" => null],
            )
        ];
