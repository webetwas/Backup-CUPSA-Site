...
?>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-left">
				<?php if($application->user->privilege < 3):?>
				<li>
                    <a href="<?=base_url()?>utilizatori">
                        <i class="fa fa-users" style=""></i> Utilizatori
                    </a>				
				</li>
                <li>
                    <a href="<?=base_url()?>legaturi">
                        <i class="fa fa-cogs" style="color:#1c84c6;"></i> Sitemap si acces utilizatori
                    </a>
                </li>
				<?php endif; ?>
            </ul>				
