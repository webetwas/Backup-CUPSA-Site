												...
												<div class="content content-full-width">
													<div class="panel-group">
														...
														<div class="row">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="ncontentanunturi"><h3>Anunturi</h3></label>
															...
															<div class="col-md-3">
																<div class="form-group">
																	<label for="ncontentlucrari_programate"><h3>Lucrari programate</h3></label>
															...
															<div class="col-md-3">
																<div class="form-group">
																	<label for="ncontentprogram_caserie"><h3>Program caserie</h3></label>
															...
															<div class="col-md-3">
																<div class="form-group">
																	<label for="ncontentlocalitati_deservite"><h3>Localitati deservite</h3></label>
																	<textarea name="<?=$form->item->prefix;?>localitati_deservite" id="ncontentlocalitati_deservite" rows="2"><?=(!is_null($item) && !is_null($item->localitati_deservite) ? $item->localitati_deservite : "");?></textarea>
																</div>
															</div>
														</div>															
														<?php endif; ?>
