											...
											<form class="form-horizontal" method="POST" name="<?=$form->item->name;?>" action="<?=base_url().$form->item->segments?>">
												<div class="content content-full-width">
													<div class="panel-group">
														...
														<div class="row">
															<div class="form-group">
																<label class="col-sm-2 control-label">Valoare</label>
																<div class="col-sm-10">
																	<input style="max-width:100px;" type="number" step="any" placeholder="Valoare " class="form-control" name="<?=$form->item->prefix;?>valoare" value="<?=(!is_null($item) && !is_null($item->valoare) ? $item->valoare : "");?>" required>
																</div>
															</div>
														</div>
														<hr>														
