...
function removediv(id, ref) {
  ...
  // only for banners(the upload button will hide)
    ...
    $("button#btnupimg").attr("style", "visibility:visible");
}
...
function upFileSuccess(id, img) {
  ...
  var html =
  '<div id="img' +fileref+ "-" +id+ '" class="col-lg-4 col-md-4 col-xs-6 col-xs-12 thumb-nomg">\
  ...
  // only for banners(the upload button will hide)
  $("button#btnupimg").hide();// $("button#" +fileref+ "btnup").hide();
  hideloader();
}
</script>