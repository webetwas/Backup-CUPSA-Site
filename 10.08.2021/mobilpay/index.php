...
<head>
	...
	<link href="<?php echo "https://" . $_SERVER['SERVER_NAME'] ?>/public/assets/css/jquery.realperson.css?v=0.00000001" rel="stylesheet">
					...
					<div class="border">
						...
						<form action="cardRedirect.php" method="post" name="frmPaymentRedirect">
							<fieldset>
								<div class="row">
									<div class="col-lg-6">
										...
										<div class="col-lg-12 col-xs-12">
											<label>Adresa:</label>
											<input class="form-control form-control-md" type="text" name="billing_address" required placeholder="introdu adresa" oninvalid="InvalidMsg(this);" value="" />
										</div>  -->
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<h6>
											<input type="checkbox" name="checkbox" class="agreed" required />
											<i>
												Am fost informat cu privire la <u><a href="https://cupfocsani.ro/p/politica-de-confidentialitate" target="_blank">Politica de Confidențialitate</a></u> a operatorului CUP SA Focșani
											</i>
										</h6>
									</div>
								</div>
							...
							<div class="col-lg-12 text-center">
								<div class="text-center">
									<a href="https://cupfocsani.ro" class="btn btn-light btn-sm">Înapoi în site</a>
