			...
			<p style="text-align: left;">			
				...
				<?php 
					...
					if($res['stare_comanda']=="confirmed"){
						echo ("<h3>Tranzactia a fost finalizata cu succes</h3>" . "<br />" . "<div style='display:none;'>" . "Id plata: " . $_GET['orderId'] . "</div>" . "<br />" . "Cod client: " . $res['codclient'] . "<br />" . "Suma: " . $res['suma'] .  " " . "Lei" . "<br />" . "Adresa:" . $res['adresa'] . "<br/>" . "Telefon:" . $res['telefon'] ."<br />" . "<a href='https://cupfocsani.ro' class='btn btn-info'>Înapoi în site</a>");		
					}					

					if($res['stare_comanda']=="confirmed_pending"){
						echo ("<h3>Tranzactia este in verificare</h3>" . "<br />" . "<div style='dispaly:none'>" . "Id plata: " . $_GET['orderId'] . "<br />" . "</div>" . "Cod client: " . $res['codclient'] . "<br />" . "<br />" . "Suma: " . $res['suma'] . " " . "Lei" . "<br />" . "Telefon:" . $res['telefon'] . "Adresa:" . $res['adresa'] . "<br />" . "<a href='https://cupfocsani.ro' class='btn btn-info'>Înapoi în site</a>");	
					}
