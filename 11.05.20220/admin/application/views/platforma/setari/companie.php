	        						...
	        						<div id="tdfirma" class="tab-pane">
												<div class="panel-body">
													...
													<div class="row">
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputEmail1">Telefon Dispecerat</label>
																<input type="text" name="<?=$form->item->prefix;?>telefon_dispecerat" class="form-control" placeholder="Telefon dispecerat" value="<?=(!empty($company->telefon_dispecerat) ? $company->telefon_dispecerat : '');?>">
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
