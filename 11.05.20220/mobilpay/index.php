									...
									<div class="col-lg-6">
										...
										<!--
											<div class="col-lg-12 col-xs-12">
												...
												<input class="form-control form-control-md just-numbers" type="number" name="numarFactura" id="numarFactura" placeholder="de pe factura dvs. *" oninvalid="InvalidMsg(this);" value="<?php //echo $factura;
