				...
				<?php endif; ?>					
					...
					?>				
							...
							<?php if($product->pret == "0.00"): ?>
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ask-ofer" data-whatever="@getbootstrap"><?=($site_lang == "en" ? 'Ask for offer' : 'Cerere Oferta pentru produsul')?>: <?=$product->{'atom_name_'. $site_lang}?></button>
							<?php endif; ?>
                        </div>
					</div>
                </div>
		  ...
		  <div class="modal-body">
			<div class="alert alert-danger" role="alert" style="display:none;" id="form-cerere-error"><?=($site_lang == "en" ? 'Please complete all fields listed bellow' : 'Te rugam sa completezi campurile de mai jos..')?></div>
			  <div class="form-group">
				...
				<input type="text" class="form-control" name="atom_name_ro" value="<?=$product->atom_name_ro?>" required>
